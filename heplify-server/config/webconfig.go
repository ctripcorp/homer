...
func WebConfig(r *http.Request) (*HeplifyServer, error) {
	...
	webSetting.DBDataAddr = r.FormValue("DBDataAddr")
	webSetting.DBConfAddr = r.FormValue("DBConfAddr")
	webSetting.DBSSLMode = r.FormValue("DBSSLMode")
	webSetting.DBDataUser = r.FormValue("DBDataUser")
	webSetting.DBConfUser = r.FormValue("DBConfUser")
	DBPass := r.FormValue("DBDataPass")
	if DBPass != "*******" {
		webSetting.DBDataPass = DBPass
	}
	DBPass = r.FormValue("DBConfPass")
	if DBPass != "*******" {
		webSetting.DBConfPass = DBPass
	}
...
<html>
    ...
    <body>
		...
		<div>
			<label>DBDataAddr</label>
			<input  type="text" name="DBDataAddr" placeholder="{{.DBDataAddr}}" value="{{.DBDataAddr}}">
		</div>
		<div>
			<label>DBConfAddr</label>
			<input  type="text" name="DBConfAddr" placeholder="{{.DBConfAddr}}" value="{{.DBConfAddr}}">
		</div>
		<div>
		...
		<div>
			<label>DBDataUser</label>
			<input  type="text" name="DBDataUser" placeholder="{{.DBDataUser}}" value="{{.DBDataUser}}">
		</div>
		<div>
			<label>DBConfUser</label>
			<input  type="text" name="DBConfUser" placeholder="{{.DBConfUser}}" value="{{.DBConfUser}}">
		</div>
		<div>
			<label>DBDataPass</label>
			<input  type="text" name="DBDataPass" placeholder="*******" value="*******">
		</div>
		<div>
			<label>DBConfPass</label>
			<input  type="text" name="DBConfPass" placeholder="*******" value="*******">
		</div>
		<div>
			<label>DBBulk</label>
