...
type HeplifyServer struct {
	...
	DBDataAddr         string   `default:"localhost:3306"`
	DBDataUser         string   `default:"root"`
	DBDataPass         string   `default:""`

	DBConfTable        string   `default:"homer_configuration"`
	DBConfAddr         string   `default:"localhost:3306"`
	DBConfUser         string   `default:"root"`
	DBConfPass         string   `default:""`
