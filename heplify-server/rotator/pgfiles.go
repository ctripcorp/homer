...
var (
	selectlogpg      = "SELECT tablename FROM pg_tables WHERE tablename LIKE 'hep_proto_100_default_%' and tablename < 'hep_proto_100_default_{{date}}_{{time}}' order by tablename asc;"
	selectreportpg   = "SELECT tablename FROM pg_tables WHERE tablename LIKE 'hep_proto_35_default_%' and tablename < 'hep_proto_35_default_{{date}}_{{time}}' order by tablename asc;"
	selectisuppg     = "SELECT tablename FROM pg_tables WHERE tablename LIKE 'hep_proto_54_default_%' and tablename < 'hep_proto_54_default_{{date}}_{{time}}' order by tablename asc;"
	selectrtcppg     = "SELECT tablename FROM pg_tables WHERE tablename LIKE 'hep_proto_5_default_%' and tablename < 'hep_proto_5_default_{{date}}_{{time}}' order by tablename asc;"
	selectcallpg     = "SELECT tablename FROM pg_tables WHERE tablename LIKE 'hep_proto_1_call_%' and tablename < 'hep_proto_1_call_{{date}}_{{time}}' order by tablename asc;"
	selectregisterpg = "SELECT tablename FROM pg_tables WHERE tablename LIKE 'hep_proto_1_registration_%' and tablename < 'hep_proto_1_registration_{{date}}_{{time}}' order by tablename asc;"
	selectdefaultpg  = "SELECT tablename FROM pg_tables WHERE tablename LIKE 'hep_proto_1_default_%' and tablename < 'hep_proto_1_default_{{date}}_{{time}}' order by tablename asc;"
)
...
var idxsippg = []string{
	...
	"CREATE INDEX IF NOT EXISTS hep_proto_1_call_{{date}}_{{time}}_id ON hep_proto_1_call_{{date}}_{{time}} (id);",
	...
	"CREATE INDEX IF NOT EXISTS hep_proto_1_call_{{date}}_{{time}}_xcid ON hep_proto_1_call_{{date}}_{{time}} ((data_header->>'X-CID'));",
	...
	"CREATE INDEX IF NOT EXISTS hep_proto_1_registration_{{date}}_{{time}}_id ON hep_proto_1_registration_{{date}}_{{time}} (id);",
	...
	"CREATE INDEX IF NOT EXISTS hep_proto_1_default_{{date}}_{{time}}_id ON hep_proto_1_default_{{date}}_{{time}} (id);",
	...
	"CREATE INDEX IF NOT EXISTS hep_proto_1_default_{{date}}_{{time}}_token ON hep_proto_1_default_{{date}}_{{time}} ((data_header->>'token'));",
	"CREATE INDEX IF NOT EXISTS hep_proto_1_default_{{date}}_{{time}}_xcid ON hep_proto_1_default_{{date}}_{{time}} ((data_header->>'X-CID'));",
}
