...
@Component({
    selector: 'app-detail-dialogls',
    templateUrl: './detail-dialog-ls.component.html',
    styleUrls: ['./detail-dialog-ls.component.scss'],
    changeDetection: ChangeDetectionStrategy.OnPush
})
export class DetailDialoglsComponent implements OnInit {
    _sipDataItem: any;
    ...
    checkStatusTabs() {
        ...
        let transaction_elements = this.sipDataItem.data.transaction_elements
        // old
        // this.tabs.logs = callData.some(f => f.method === "LOG" || f.method === "100")
        this.tabs.logs = transaction_elements.some(f => f.call_data.some(t => t.method === "LOG" || t.method === "100" ))
